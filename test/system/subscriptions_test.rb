...
class SubscriptionsTest < ApplicationSystemTestCase
  ...
  test "creating a Subscription" do
    ...
    fill_in "Frequancey", with: @subscription.frequancey
    fill_in "Num of board", with: @subscription.num_of_board
    fill_in "Num of seat", with: @subscription.num_of_seat
    fill_in "Organization", with: @subscription.organization_id
